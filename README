...
I made a python scraper for https://www.dicionáriomédico.com/ and further refined it using **regex** (so terms like "Apgar, coeficiente" becomes "coeficiente Apgar".
